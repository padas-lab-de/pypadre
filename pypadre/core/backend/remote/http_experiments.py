...
from pypadre.core.backend.http.protobuffer.protobuf import resultV1_pb2 as proto
from requests_toolbelt import MultipartEncoder

from pypadre import experimentcreator
from pypadre.core import Experiment, Run, Split
from pypadre.core.backend.serialiser import PickleSerializer
...
class HttpBackendExperiments:
    ...
    def validate_and_save(self, experiment, run=None, split=None, local_experiments=None):
        ...
        :type local_experiments: <class 'pypadre.core.backend.file.ExperimentFileRepository'>
