...
#                 for key_value in list(experiment.keys()):
#                     experiment_dict[key_value] = experiment.get(key_value)
#
#                 # Add the dataset as a string or a dataset object
...
#                         experiment_dict[key_value] = experiment.get(key_value)
#
#                     # Set the dataset as a single dataset of the outer loop and also the name
