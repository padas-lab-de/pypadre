...
# from pypadre.pod.backend.http.protobuffer.protobuf import resultV1_pb2 as proto
...
#
#
# class HttpRepositoryExperiments:
...
#         :type local_experiments: <class 'pypadre.pod.backend.file.ExperimentFileRepository'>
