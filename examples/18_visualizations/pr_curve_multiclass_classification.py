"""
Create and save visualization for precision recall curve for multi class classification.
...
@app.experiment(dataset=digits, reference_git=__file__,
                experiment_name="Multi class Precision Recall Visualization Example " + name,
                seed=500,
...
app.backends[0].dataset.put_visualization(vis,
                                          file_name="multi_precision_recall.json",
