...
def create_from_padre_dataset( padre_dataset,source,target, node_attr=[],edge_attr=[],directed=False):
    ...
    Args:
        padre_dataset (padre.dataset): The dataset that is converted.
    ...
    Returns:
        padre.Dataset() A padre_dataset containing the data of the padre_dataset, but converted to support graphs.
    """
...
def create_from_snap(url,link_num=0):
    """Takes the graph of the Snap website and puts it into a padre.dataset.
    ...
    Returns:
        A padre.dataset object that conatins the graph of the url.
    """
    meta_dict={}
...
def create_from_konect(url,zero_based=False):
    """Takes the graph of the Konect website and puts it into a padre.dataset.
